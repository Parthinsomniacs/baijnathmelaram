    ...
    <div class="ship-details-container theme-padding">
      ...
      <div class="ship-details-header">
        ...
        <div class="ship-header-center">
          <h1 class="ship-detail-title">FPSO</h1>
        </div>

        <div class="ship-header-right">
          <div class="ship-nav-arrows">
            <a href="<?php echo $siteurl; ?>rorocrew.php" class="ship-nav-btn" title="Previous: Roro & Crew" aria-label="Previous">
              <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round">
                <polyline points="15 18 9 12 15 6"></polyline>
              </svg>
            </a>
            <a href="<?php echo $siteurl; ?>military.php" class="ship-nav-btn" title="Next: Military" aria-label="Next">
              <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round">
      ...
      <div class="ship-table-card">
        <div class="ship-table-responsive">
          <table class="ship-data-table">
            ...
            <tbody>
              <tr>
                <td class="td-ship-name">M.T. ROAR</td>
                <td class="td-ship-type">FPSO</td>
                <td class="td-ship-year">2022/23</td>
                <td class="td-ship-ltd">26293.5</td>
              </tr>
            </tbody>
          </table>
        </div>
