<?php
	...
	require "../../include/inc-smtp.php";

	$subject = $emailsendername." | " .$emailsubject;
	$emailbanner = "";
	$toname = $name ="Insomniacs Team";
	$toemail = $email = "sagar@themidnight.in";
	$phone = "9925743801";
						...
						<tbody>
						  <tr>
							<td><table width='100%' cellspacing='0' cellpadding='0' border='0' style='padding:30px 4% 0px 4%;'>
								<tbody>
								  <tr>
									<td width='100%' align='center' style='font-size:12px;padding-bottom: 15px;font-family: Tahoma,Geneva,sans-serif;'>&copy; ".date("Y")." ".$copyrightname."</td>
								  </tr>";
								if($facebookurl == "" && $twitterurl == "" && $linkedinurl == "" && $youtubeurl == "" && $instagramurl == ""){}else{
								$body .= "
								  <tr>
