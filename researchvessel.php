    ...
    <div class="ship-details-container theme-padding">
      ...
      <div class="ship-details-header">
        ...
        <div class="ship-header-center">
          <h1 class="ship-detail-title">Research Vessel</h1>
        </div>

        <div class="ship-header-right">
          <div class="ship-nav-arrows">
            <a href="<?php echo $siteurl; ?>military.php" class="ship-nav-btn" title="Previous: Military" aria-label="Previous">
      ...
      <div class="ship-table-card">
        <div class="ship-table-responsive">
          <table class="ship-data-table">
            ...
            <tbody>
              <tr>
                <td class="td-ship-name">M.V. IGEN PEARL</td>
                <td class="td-ship-type">RESEARCH VESSEL</td>
                <td class="td-ship-year">1999-00</td>
                <td class="td-ship-ltd">3489</td>
              </tr>
            </tbody>
          </table>
        </div>
